 ...
 */
[_LOWER] = LAYOUT(
   _______,    KC_2, _______, _______, _______, _______,                    KC_F19,  KC_F20,  KC_F21,  KC_F22,  KC_F23,  KC_F24,
...
DF(_QWERTY),DF(_DVORAK),_______,_______,_______,_______,                   _______, _______, KC_KP_7, KC_KP_8, KC_KP_9, KC_PSLS,
   _______, _______, _______, KC_BTN4, KC_BTN5, _______,                   _______, _______, KC_KP_4, KC_KP_5, KC_KP_6, KC_PAST,
   _______, _______, _______, KC_BTN1, KC_BTN2, KC_BTN3,                   _______, _______, KC_KP_1, KC_KP_2, KC_KP_3, KC_PMNS,
...
//SSD1306 OLED update loop, make sure to enable OLED_ENABLE=yes in rules.mk
    ...
    oled_rotation_t oled_init_user(oled_rotation_t rotation) {
      if (is_keyboard_master() || !is_keyboard_master())
